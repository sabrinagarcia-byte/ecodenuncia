  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-gray-50 py-16 px-6 flex justify-center">
        <div className="max-w-5xl w-full bg-white rounded-3xl shadow-lg p-10 flex flex-col md:flex-row items-center gap-10">

          <div className="flex-1 text-center md:text-left">
            <p className="bg-green-900 text-white px-4 py-1 rounded-2xl text-xl font-semibold w-fit mx-auto md:mx-0 mb-4">
              Quem Somos?
            </p>
          ...
          <img
            src={ImgQuemSomos}
            className="w-80 object-cover rounded-2xl shadow-md"
            alt="Quem Somos"
          />
        </div>
      </div>

      <div className="bg-gray-50 pb-20 px-6 flex justify-center">
        <div className="max-w-5xl w-full grid md:grid-cols-3 gap-6">

         <div className="bg-white rounded-2xl p-5 shadow-md border-t-4 border-green-700 text-center flex flex-col items-center">
      ...
      <div className="relative py-20 text-white bg-green-950">
        <div className="absolute inset-0 bg-green-900/80"></div>

        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-4">Nossa Equipe</h2>
          <p className="text-xl mb-12 text-green-100">Conheça as pessoas por trás do EcoDenúncia</p>

          <div className="flex flex-col md:flex-row justify-center gap-8">

            <div className="bg-white text-gray-800 rounded-2xl p-6 w-full max-w-xs mx-auto shadow-lg hover:-translate-y-1 transition-transform">
              <img src={Ana} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" alt="Ana" />
              <h4 className="font-bold text-lg text-green-950">Ana Beatriz dos Santos Maia</h4>
              <p className="text-sm text-green-700 font-medium">Desenvolvedora / Designer</p>
            </div>

            <div className="bg-white text-gray-800 rounded-2xl p-6 w-full max-w-xs mx-auto shadow-lg hover:-translate-y-1 transition-transform">
              <img src={Sabrina} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover" alt="Sabrina" />
              <h4 className="font-bold text-lg text-green-950">Sabrina Garcia Gonçalves</h4>
              <p className="text-sm text-green-700 font-medium">Desenvolvedora / Designer</p>
            </div>

            <div className="bg-white text-gray-800 rounded-2xl p-6 w-full max-w-xs mx-auto shadow-lg hover:-translate-y-1 transition-transform">
              <img src={Yasmin} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover " alt="Yasmin" />
              <h4 className="font-bold text-lg text-green-950">Yasmin Rodrigues da Silva</h4>
              <p className="text-sm text-green-700 font-medium">Desenvolvedora / Designer</p>
            </div>
      ...
      {/* CTA */}
      <div className="relative h-56 flex items-center justify-center text-white text-center">
        ...
        <div className="relative z-10 px-6">
          ...
          <NavLink to="/denunciar" className="inline-block bg-green-600 text-lg px-8 py-3 rounded-full font-bold hover:bg-green-500 transition-colors shadow-lg">
            Denunciar agora
          </NavLink>
        </div>
      </div>
