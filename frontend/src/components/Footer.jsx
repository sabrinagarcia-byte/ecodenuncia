  ...
  return (
    <footer className="bg-green-950 text-white py-8">
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-green-800 pt-6">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-green-100 text-base leading-relaxed max-w-[250px]">
              Cuidando do meio ambiente através do descarte consciente.
            </p>
          </div>

          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h1 className="text-xl font-bold mb-3 text-white">Links Rápidos</h1>

            <nav className="flex flex-col gap-2 text-base items-center md:items-start">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h1 className="text-xl font-bold mb-3 text-white">Fale Conosco</h1>

            <div className="flex flex-col gap-3 text-base items-center md:items-start text-gray-300">
        ...
        <div className="mt-8 pt-4 border-t border-green-800 text-center text-base text-gray-400">
